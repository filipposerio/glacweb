...
module.exports = {
  ...
  createRicetta: function  (user_map, socket) {
    const lconfig = conf.fnDatabase();
    console.log("createRicetta stampo contenuto user_map")
    console.log(user_map)
    ...
    const qry = "insert into ricette (nricetta,datafruizione,datacompilazione, idAccettazione,idanagrafica, codesenzione,coddiagnosi,ssn,esente) values ('" + user_map.nRicetta+"','"+ user_map.dataFruizione+"','"+ user_map.dataRicetta+"','"+ user_map.idaccettazione+"','"+ user_map.idanagrafica+"','"+user_map.codice_esenzione+"','"+user_map.diagnosi+"','"+user_map.ssn+"','"+user_map.esente+"')"
...
createRicettaWebMSSQL: function (lconfig,ricetta_map,result,socket) {
 ...
 const qry = "insert into ricette (nRicetta,datacompilazione, idAccettazione,idanagrafica,SSN,codesenzione,coddiagnosi) values ('" + ricetta_map.nRicetta+"','"+ result.dataCompilazione+"','"+ ricetta_map.idAccettazione+"','"+ ricetta_map.idPaziente+"','S','"+result.codEsenzione+"','"+result.descrizioneDiagnosi+"') returning idricetta insertId"
...
createRicettaWebMariaDB: function (lconfig,ricetta_map,result,socket) {
 ...
 const qry = "insert into ricette (nRicetta,datacompilazione, datafruizione, idAccettazione,idAnagrafica,codesenzione) values ('" + ricetta_map.nricetta+"','"+ result.dataCompilazione+"','"+ ricetta_map.dataFruizione+"','"+ ricetta_map.idAccettazione+"','"+ ricetta_map.idPaziente+"','"+result.codEsenzione+"') returning idricetta insertId"
