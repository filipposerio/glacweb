...
createRicettaWebMariaDB: function (lconfig,ricetta_map,result,socket) {
 ...
 const qry = "insert into ricette (nRicetta,datacompilazione, idAccettazione,idAnagrafica,codesenzione) values ('" + ricetta_map.nricetta+"','"+ result.dataCompilazione+"','"+ ricetta_map.idAccettazione+"','"+ ricetta_map.idPaziente+"','"+result.codEsenzione+"') returning idricetta insertId"
