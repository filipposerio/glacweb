...
var
  ...
  simulatoreRicette = require('./simulatoreRicettaWeb.js'),
   ...
   //port.connect(io)
    ...
    io
      ...
      .on( 'connection', function ( socket ) {
        ...
        socket.on('searchRicettaWebSimulata', function( ricetta_map ) {
          ...
          simulatoreRicette.createRicettaWeb(lconfig,ricetta_map,socket)
        });
